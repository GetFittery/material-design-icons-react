...
const SvgBeachAccess = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
    <path
      d="M7.6 7.6c-.47 2.34.03 4.78 1.39 6.83l5.45-5.45a9.126 9.126 0 0 0-5.08-1.56c-.6 0-1.19.06-1.76.18M13.12 5c-.93 0-1.82.16-2.67.46 1.91.19 3.79.89 5.44 2.07l1.39-1.39A8.126 8.126 0 0 0 13.12 5M5 13.12c0 1.49.4 2.91 1.14 4.15l1.39-1.39a11.247 11.247 0 0 1-2.07-5.44c-.3.86-.46 1.76-.46 2.68"
      opacity={0.3}
    />
