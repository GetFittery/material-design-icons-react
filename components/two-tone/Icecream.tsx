...
const SvgIcecream = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
    <path
      d="m9.32 13.42 2.73 5.21 2.67-5.23a6.468 6.468 0 0 1-5.4.02m7.99-5.4-.77-.12-.06-.78C16.29 4.8 14.34 3 12 3S7.71 4.8 7.51 7.12l-.06.78-.77.13A1.999 1.999 0 0 0 7 12c.52 0 1.01-.21 1.39-.56l.56-.54.66.41a4.52 4.52 0 0 0 4.78.01l.66-.42.56.54c.38.36.87.56 1.39.56 1.1 0 2-.9 2-2 0-.99-.72-1.82-1.69-1.98"
      opacity={0.3}
    />
