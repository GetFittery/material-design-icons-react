...
const SvgLinkedCamera = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
    ...
    <path
      d="M14.98 10.01c-.13-.09-.26-.18-.39-.26.14.08.27.17.39.26M17 9a2.015 2.015 0 0 0-1.01-1.73C15.7 7.1 15.36 7 15 7V6H9.88L8.05 8H4v12h16V9zm-5 10c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5"
      opacity={0.3}
    />
